...
[![Go Report Card](https://goreportcard.com/badge/github.com/plinx2/grepo)](https://goreportcard.com/report/github.com/plinx2/grepo)
...
```bash
go get github.com/plinx2/grepo
```

`go.mod` に追加:
```go
require github.com/plinx2/grepo v0.1.0
```
